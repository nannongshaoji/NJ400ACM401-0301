...
extern uint8	TIMER_10MS_MARK;
extern uint16   MS10_CNT;
extern uint8	SYS_TIMER1;					//DECLARE SYS_TIMER1			BYTE    SLOW;
extern uint8	SYS_TIMER2;					//DECLARE SYS_TIMER2			BYTE    SLOW;
extern uint16	SYS_TIMER3;					//DECLARE SYS_TIMER3			BYTE    SLOW;
extern uint8	SYS_TIMER4;					//DECLARE SYS_TIMER4			BYTE    SLOW;
extern uint8	SYS_TIMER5;					//DECLARE SYS_TIMER5			BYTE    SLOW;
extern uint8	SYS_TIMER6;					//DECLARE SYS_TIMER6			BYTE    SLOW;
extern uint8	SYS_TIMER7;					//DECLARE SYS_TIMER7			BYTE    SLOW;
extern uint8	SYS_TIMER8;					//DECLARE SYS_TIMER8			BYTE    SLOW;
